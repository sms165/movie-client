...
},{"react-refresh/runtime":"eqMEG"}],"ej4AK":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "69f74e7f31319ffd";
module.bundle.HMR_BUNDLE_ID = "55f86a0d38e15e92";
"use strict";
...
},{}],"8NvwB":[function(require,module,exports) {
"use strict";
...
var YouTube1 = /*#__PURE__*/ function(_Component) {
            ...
            value: function load(url, isReady) {
                ...
                if (isReady) {
                    ...
                    this.player.cueVideoById({
                        videoId: id,
                        startSeconds: _utils.parseStartTime(url) || playerVars.start,
                        endSeconds: _utils.parseEndTime(url) || playerVars.end
                    });
                    return;
                }
                _utils.getSDK(SDK_URL, SDK_GLOBAL, SDK_GLOBAL_READY, function(YT) {
                    return YT.loaded;
                }).then(function(YT) {
                    ...
                    _this2.player = new YT.Player(_this2.container, _objectSpread({
                        ...
                        playerVars: _objectSpread(_objectSpread({
                            ...
                            start: _utils.parseStartTime(url),
                            end: _utils.parseEndTime(url),
...
exports["default"] = YouTube1;
_defineProperty(YouTube1, "displayName", 'YouTube');
_defineProperty(YouTube1, "canPlay", _patterns.canPlay.youtube);

},{"react":"6TuXu","../utils":"baCpc","../patterns":"jZYIs"}]},["9NtYk","ej4AK"], null, "parcelRequire315a")

//# sourceMappingURL=YouTube.38e15e92.js.map
